...
HLS_SOURCES = ../../../../tb_matmul.cpp ../../../../matmul.cpp
...
$(ObjDir)/tb_matmul.o: ../../../../tb_matmul.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../tb_matmul.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/tb_matmul.d

$(ObjDir)/matmul.o: ../../../../matmul.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../matmul.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
