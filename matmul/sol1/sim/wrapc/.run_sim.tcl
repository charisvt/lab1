...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mult_hw.autotvin.dat"
	set constFileTvOut       "mult_hw.autotvout.dat"
	set constFileHdlTvIn     "mult_hw.autohdltvin.dat"
	set constFileHdlTvOut    "mult_hw.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
