...
`define AUTOTB_DUT      mult_hw
`define AUTOTB_DUT_INST AESL_inst_mult_hw
`define AUTOTB_TOP      apatb_mult_hw_top
`define AUTOTB_LAT_RESULT_FILE "mult_hw.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mult_hw.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mult_hw_top
...
parameter LATENCY_ESTIMATION = 16413;
parameter LENGTH_gmem = 8192;
parameter LENGTH_gmem0 = 4608;
