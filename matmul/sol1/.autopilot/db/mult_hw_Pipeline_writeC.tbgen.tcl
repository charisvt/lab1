set moduleName mult_hw_Pipeline_writeC
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {mult_hw_Pipeline_writeC}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 1}  }
	{ sext_ln60 int 62 regular  }
	{ C_V int 22 regular {array 4096 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln60", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "C_V", "interface" : "memory", "bitwidth" : 22, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln60 sc_in sc_lv 62 signal 1 } 
	{ C_V_address0 sc_out sc_lv 12 signal 2 } 
	{ C_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ C_V_q0 sc_in sc_lv 22 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln60", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln60", "role": "default" }} , 
 	...
 	{ "name": "C_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":22, "type": "signal", "bundle":{"name": "C_V", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln60 { ap_none {  { sext_ln60 in_data 0 62 } } }
	C_V { ap_memory {  { C_V_address0 mem_address 1 12 }  { C_V_ce0 mem_ce 1 1 }  { C_V_q0 mem_dout 0 22 } } }
}
